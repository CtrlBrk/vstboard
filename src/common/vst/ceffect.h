...
namespace vst
{
    ...
    // no idea how things look here...
        ...
        virtual long EffDispatch(VstInt32 opCode, VstInt32 index=0, VstIntPtr value=0, void *ptr=0, float opt=0., VstInt32 size=0);
        ...
        virtual void EffSetProgramName(char *ptr, VstInt32 size) { EffDispatch(effSetProgramName, 0, 0, ptr,0,size); }
        virtual void EffGetProgramName(char *ptr, VstInt32 size) { EffDispatch(effGetProgramName, 0, 0, ptr,0,size); }
        virtual void EffGetParamLabel(long index, char *ptr, VstInt32 size) { EffDispatch(effGetParamLabel, index, 0, ptr,0,size); }
        virtual void EffGetParamDisplay(long index, char *ptr, VstInt32 size) { EffDispatch(effGetParamDisplay, index, 0, ptr,0,size); }
        virtual long EffGetParamName(long index,char *txt, VstInt32 size) { return EffDispatch(effGetParamName, index, 0, txt,0,size); }
        ...
        virtual long EffSetChunk(void *data, long byteSize, bool isPreset = false) { EffBeginSetProgram(); long lResult = EffDispatch(effSetChunk, isPreset, byteSize, data,0,byteSize); EffEndSetProgram(); return lResult;}
                                            /* VST 2.0                           */
        virtual long EffProcessEvents(VstEvents* ptr, VstInt32 size) { return EffDispatch(effProcessEvents, 0, 0, ptr,0, size); }
        virtual long EffCanBeAutomated(long index) { return EffDispatch(effCanBeAutomated, index); }
        virtual long EffString2Parameter(long index, char *ptr, VstInt32 size) { return EffDispatch(effString2Parameter, index, 0, ptr,0, size); }
        virtual long EffGetNumProgramCategories() { return EffDispatch(effGetNumProgramCategories); }
        virtual long EffGetProgramNameIndexed(long category, long index, char* text, VstInt32 size) { return EffDispatch(effGetProgramNameIndexed, index, category, text,0, size); }
        ...
        virtual long EffGetInputProperties(long index, VstPinProperties *ptr, VstInt32 size) { return EffDispatch(effGetInputProperties, index, 0, ptr,0, size); }
        virtual long EffGetOutputProperties(long index, VstPinProperties *ptr, VstInt32 size) { return EffDispatch(effGetOutputProperties, index, 0, ptr,0, size); }
        ...
        virtual long EffOfflineNotify(VstAudioFile* ptr, long numAudioFiles, bool start, VstInt32 size) { return EffDispatch(effOfflineNotify, start, numAudioFiles, ptr,0, size); }
        virtual long EffOfflinePrepare(VstOfflineTask *ptr, long count, VstInt32 size) { return EffDispatch(effOfflinePrepare, 0, count, ptr,0, size); }
        virtual long EffOfflineRun(VstOfflineTask *ptr, long count, VstInt32 size) { return EffDispatch(effOfflineRun, 0, count, ptr,0, size); }
        virtual long EffProcessVarIo(VstVariableIo* varIo, VstInt32 size) { return EffDispatch(effProcessVarIo, 0, 0, varIo,0, size); }
        virtual long EffSetSpeakerArrangement(VstSpeakerArrangement* pluginInput, VstSpeakerArrangement* pluginOutput, VstInt32 size) { return EffDispatch(effSetSpeakerArrangement, 0, (VstIntPtr)pluginInput, pluginOutput,0, size); }
        ...
        virtual long EffGetEffectName(char *ptr, VstInt32 size) { return EffDispatch(effGetEffectName, 0, 0, ptr,0, size); }
        virtual long EffGetErrorText(char *ptr, VstInt32 size) { return EffDispatch(effGetErrorText, 0, 0, ptr,0,size); }
        virtual long EffGetVendorString(char *ptr, VstInt32 size) { return EffDispatch(effGetVendorString, 0, 0, ptr,0,size); }
        virtual long EffGetProductString(char *ptr, VstInt32 size) { return EffDispatch(effGetProductString, 0, 0, ptr,0,size); }
        virtual long EffGetVendorVersion() { return EffDispatch(effGetVendorVersion); }
        virtual long EffVendorSpecific(long index, long value, void *ptr, float opt, VstInt32 size) { return EffDispatch(effVendorSpecific, index, value, ptr, opt,size); }
        virtual long EffCanDo(const char *ptr, VstInt32 size) { return EffDispatch(effCanDo, 0, 0, (void *)ptr,0,size); }
        ...
        virtual long EffGetParameterProperties(long index, VstParameterProperties* ptr, VstInt32 size) { return EffDispatch(effGetParameterProperties, index, 0, ptr,0,size); }
        ...
        virtual long EffGetVstVersion() { return EffDispatch(effGetVstVersion); }
                                            /* VST 2.1 extensions                */
        virtual long EffKeyDown(VstKeyCode &keyCode, VstInt32 size) { return EffDispatch(effEditKeyDown, keyCode.character, keyCode.virt, 0, keyCode.modifier,size); }
        virtual long EffKeyUp(VstKeyCode &keyCode, VstInt32 size) { return EffDispatch(effEditKeyUp, keyCode.character, keyCode.virt, 0, keyCode.modifier,size); }
        virtual void EffSetKnobMode(long value) { EffDispatch(effSetEditKnobMode, 0, value); }
        virtual long EffGetMidiProgramName(long channel, MidiProgramName* midiProgramName, VstInt32 size) { return EffDispatch(effGetMidiProgramName, channel, 0, midiProgramName,0,size); }
        virtual long EffGetCurrentMidiProgram (long channel, MidiProgramName* currentProgram, VstInt32 size) { return EffDispatch(effGetCurrentMidiProgram, channel, 0, currentProgram,0,size); }
        virtual long EffGetMidiProgramCategory (long channel, MidiProgramCategory* category, VstInt32 size) { return EffDispatch(effGetMidiProgramCategory, channel, 0, category,0,size); }
        virtual long EffHasMidiProgramsChanged (long channel) { return EffDispatch(effHasMidiProgramsChanged, channel); }
        virtual long EffGetMidiKeyName(long channel, MidiKeyName* keyName, VstInt32 size) { return EffDispatch(effGetMidiKeyName, channel, 0, keyName,0,size); }
        ...
        virtual long EffEndSetProgram() { bInSetProgram = false; return EffDispatch(effEndSetProgram); }
                                            /* VST 2.3 Extensions                */
        virtual long EffGetSpeakerArrangement(VstSpeakerArrangement** pluginInput, VstSpeakerArrangement** pluginOutput, VstInt32 size) { return EffDispatch(effGetSpeakerArrangement, 0, (VstIntPtr)pluginInput, pluginOutput,0,size); }
        virtual long EffSetTotalSampleToProcess (long value) { return EffDispatch(effSetTotalSampleToProcess, 0, value); }
        virtual long EffGetNextShellPlugin(char *name, VstInt32 size) { return EffDispatch(effShellGetNextPlugin, 0, 0, name,0,size); }
        ...
        virtual long EffBeginLoadBank(VstPatchChunkInfo* ptr, VstInt32 size) { return EffDispatch(effBeginLoadBank, 0, 0, ptr,0,size); }
        virtual long EffBeginLoadProgram(VstPatchChunkInfo* ptr, VstInt32 size) { return EffDispatch(effBeginLoadProgram, 0, 0, ptr,0,size); }
                                            /* VST 2.4 extensions                */
